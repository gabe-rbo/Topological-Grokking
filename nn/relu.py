"""
Train the grok Transformer with ReLU feed-forward activations.
...
def train(
    ...
    **hparam_overrides: Any,
    ...
    """
    Train grok's Transformer with ReLU feed-forward activations
    (hparams.non_linearity forced to "relu").
    ...
    parameter here is forwarded to it unchanged, plus "relu" as nn_type.
