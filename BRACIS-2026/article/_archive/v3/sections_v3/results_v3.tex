...
Figures~\ref{fig:sum-decoder0-linear-30pct} and~\ref{fig:sum-decoder0-linear-20pct} show the evolution of $\beta_0$, $\beta_1$, and $\beta_2$ for $q \in \{30\%, 20\%\}$. A consistent pattern accompanies the surge in validation accuracy: in the first decoder block, $\beta_0$ decreases monotonically, indicating association of disjoint activation clusters into fewer coherent connected components; in the linear projection layer, $\beta_0$ increases and stabilizes, indicating the formation of well-separated output clusters corresponding to the $p = 97$ target classes. Higher-dimensional Betti numbers $\beta_1$ and $\beta_2$ remain near zero throughout, indicating that the representation manifold does not develop persistent loops or voids during training and that the relevant topological dynamics are captured by $\beta_0$ alone. While this observation means that connected-component counting alone would have sufficed \emph{post hoc}, the absence of higher-dimensional features is itself a non-trivial finding that could not have been assumed \emph{a priori}: the pipeline was designed to detect features in all dimensions below the ambient space, and confirming their absence rules out richer topological structure. Moreover, the persistent-homology-based computation of $\beta_0$ is more principled than single-threshold clustering methods such as DBSCAN, as it provides component counts that are robust to noise through the persistence filtration (Section~\ref{subsec:simplicial}).

\begin{figure}[htbp]
    \centering
    \includesvg[width=0.49\linewidth]{plots/sum/DE-evolution_betti_acc_reduced_decoder_0_activations-30pct-k31-95percentil.svg}\hfill
    \includesvg[width=0.49\linewidth]{plots/sum/DE-evolution_betti_acc_reduced_linear_activations-30pct-k31-95percentil.svg}
    \caption[30\% of training data.]{\textbf{30\% of training data.} Evolution of the Betti numbers for the first decoder (left) and linear (right) blocks. Notice that as validation accuracy rises, the number of connected components decreases for the first decoder block, while the opposite occurs in the linear block.}
    \label{fig:sum-decoder0-linear-30pct}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includesvg[width=0.49\linewidth]{plots/sum/DE-evolution_betti_acc_reduced_decoder_0_activations-20pct-k31-95percentil.svg}\hfill
    \includesvg[width=0.49\linewidth]{plots/sum/DE-evolution_betti_acc_reduced_linear_activations-20pct-k31-95percentil.svg}
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.49\linewidth]{plots/sum/DE-evolution_betti_acc_reduced_decoder_0_activations-15pct-k31-95percentil.svg}\hfill
    \includesvg[width=0.49\linewidth]{plots/sum/DE-evolution_betti_acc_reduced_linear_activations-15pct-k31-95percentil.svg}
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.49\linewidth]{plots/prod/prod-DE-evolution_betti_acc_reduced_decoder_0_activations-30pct-k31-95percentil.svg}\hfill
    \includesvg[width=0.49\linewidth]{plots/prod/prod-DE-evolution_betti_acc_reduced_linear_activations-30pct-k31-95percentil.svg}
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.49\linewidth]{plots/prod/prod-DE-evolution_betti_acc_reduced_decoder_0_activations-20pct-k31-95percentil.svg}\hfill
    \includesvg[width=0.49\linewidth]{plots/prod/prod-DE-evolution_betti_acc_reduced_linear_activations-20pct-k31-95percentil.svg}
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.49\linewidth]{plots/prod/prod-DE-evolution_betti_acc_reduced_decoder_0_activations-15pct-k31-95percentil.svg}\hfill
    \includesvg[width=0.49\linewidth]{plots/prod/prod-DE-evolution_betti_acc_reduced_linear_activations-15pct-k31-95percentil.svg}
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.78\linewidth]{plots/sum/Intrinsic-Dimension-Evolution_Decoder0.svg} 
    \includesvg[width=0.78\linewidth]{plots/sum/Intrinsic-Dimension-Evolution_Decoder1.svg} 
    \includesvg[width=0.78\linewidth]{plots/sum/Intrinsic-Dimension-Evolution_Linear.svg} 
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.78\linewidth]{plots/prod/prod-data-Intrinsic-Dimension-Evolution_prod_dataDecoder0.svg} 
    \includesvg[width=0.78\linewidth]{plots/prod/prod-data-Intrinsic-Dimension-Evolution_prod_dataDecoder1.svg} 
    \includesvg[width=0.78\linewidth]{plots/prod/prod-data-Intrinsic-Dimension-Evolution_prod_dataLinear.svg} 
